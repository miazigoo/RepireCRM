...
class DeviceModel(models.Model):
    ...
    brand = models.ForeignKey(
        DeviceBrand, on_delete=models.CASCADE, verbose_name="Бренд"
    )
    device_type = models.ForeignKey(
        DeviceType, on_delete=models.CASCADE, verbose_name="Тип устройства"
    )
...
class Device(models.Model):
    ...
    model = models.ForeignKey(
        DeviceModel, on_delete=models.PROTECT, verbose_name="Модель"
    )
