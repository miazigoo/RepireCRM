...
class ProductionConfigTestCase(SimpleTestCase):
    ...
    def test_ci_pipeline_runs_real_deploy_script(self):
        ...
        self.assertIn("DEPLOY_BACKUP_BEFORE_DEPLOY", deploy_script_text)
        self.assertIn("repaircrm-predeploy-", deploy_script_text)
        self.assertIn("pg_dump", deploy_script_text)
